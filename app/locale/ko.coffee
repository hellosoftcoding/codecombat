module.exports = nativeDescription: "한국어", englishDescription: "Korean", translation:
  ...
  new_home:
    ...
    creativity_rigor_title: "창의성과 엄격함이 만나는 곳"
    creativity_rigor_subtitle1: "재미있게 코딩하고 실제 기술을 가르치세요."
    creativity_rigor_blurb1: "학생들은 시행 착오, 비판적 사고 및 창의성을 장려하는 게임을 하면서, 실제 Python 및 JavaScript 코드를 입력합니다. 그런 다음 학생들은 프로젝트 기반 과정에서 자기만의 게임과 웹 사이트를 개발하면서 자신이 배운 코딩 기술을 적용합니다."
    creativity_rigor_subtitle2: "레벨에 따라 학생들에게 접근하세요."
    creativity_rigor_blurb2: "모든 CodeCombat 레벨은 수백만 개의 데이터를 기반으로 구현되며 각 학습자에 맞게 최적화됩니다. 실습 레벨 및 힌트는 학생들이 막힐 때 도움이 되고 도전 레벨은 게임 내내 학생들의 학습을 평가합니다."
    creativity_rigor_subtitle3: "교사들의 경험에 관계없이 모든 교사를 위한 설계"
    creativity_rigor_blurb3: "CodeCombat 의 자율적이고 표준에 맞춘 커리큘럼은 모든 사람이 컴퓨터 과학을 가르치는 것을 가능하게 합니다. CodeCombat은 교사가 강의실에서 자신감과 성공을 느낄 수 있도록 연수, 교육 자료 및 전폭적인 지원을 제공합니다."
...
#    go_to_my_classes: "내 학급으로 가기"
#    go_to_my_courses: "내 학습으로 가기"
